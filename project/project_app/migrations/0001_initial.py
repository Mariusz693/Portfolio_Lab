# Generated by Django 3.0.6 on 2021-03-07 18:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.SmallIntegerField(choices=[(1, 'Fundacja'), (2, 'Organizacja pozarządowa'), (3, 'Zbiórka lokalna')], default=1, verbose_name='Rodzaj')),
                ('categories', models.ManyToManyField(to='project_app.Category', verbose_name='Kategorie darowizny')),
            ],
            options={
